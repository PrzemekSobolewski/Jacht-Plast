    ...
    <Layout>
        <Parallax bgImage={jacht} strength={600} bgImageStyle={'bg'}>
            <div className={'bgContainer'}>
                ...
                <ScrollTo>
                    {({scrollTo}) => <div className={'bgButtonContainer'} onClick={() => scrollTo({x: 0, y: 700, smooth: true})}>
        ...
        <div className={"about_us_div"} style={{backgroundColor: 'white'}}>
            Firma ,,JACHT – PLAST” zajmuje się budową jachtów żaglowych i motorowych.Od wielu lat jesteśmy głównym
            ...
            standardy jakości i bezpieczeństwa.<br/>
