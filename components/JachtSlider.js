...
const JachtSlider = () => {
  ...
  const images = [water, interior, exterior, boat];
      ...
      <div className={"bgContainer2"}>
        <div className="fadein">
          <img
            id="f1"
            src={images[1]}
            alt="Wnętrze siedziby firmy przepełnione jachtami w produkcji"
          />
          <img
            id="f2"
            src={images[0]}
            alt="Łódź żaglowa na płynąca po jeziorze"
          />
          <img
            id="f3"
            src={images[2]}
            alt="Transport jachtu z wykorzystaniem samochodu Dodge Ram oraz odpowiednio przystosowanej przyczepy"
          />
